...
export default function HomeSections() {
  return (
    <section className="px-6 py-4 bg-[oklch(0.4_0.013807_253.101)] text-white transition-colors duration-300">
      <div className="max-w-6xl mx-auto text-center space-y-10">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-10">
          {steps.map((step, index) => (
            <div
              key={index}
              className="p-6 rounded-2xl bg-gray-800 shadow-md text-left"
            >
